...
function ff_initWysiwyg()
{
	tinyMCE.init({
		...
		theme_advanced_buttons1:"bold,italic,underline,strikethrough,charmap|,link,unlink,|,sub,sup,|,bullist,numlist,|,indent,outdent,|,tablecontrols,table,row_props,cell_props,delete_col,delete_row,col_after,col_before,row_after,row_before,split_cells,merge_cells,",
        	theme_advanced_buttons2 : ",cut,copy,paste,pastetext,|,cleanup,removeformat,|,search,replace,|,undo,redo",
